...
class Player:
    ...
    def draw(self):
        ...
        pygame.draw.circle(self.app.screen, PLAYER_COLOUR, (WIDTH-80, HEIGHT//2 - 25), 10)
        self.app.draw_text('x {}'.format(self.lives), self.app.screen, [ WIDTH - 65, HEIGHT//2- 40 ], 18, WHITE, START_FONT)
